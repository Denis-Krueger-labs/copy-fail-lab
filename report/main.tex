...
% ------------------------------------------------------------
% References use LaTeX's built-in bibliography so the report remains a
% single-pass pdflatex project and does not require a separate biber run.
% ------------------------------------------------------------
% ------------------------------------------------------------
...
\begin{titlepage}
    ...
    {\displayfont\scriptsize\bfseries\color{MoriLavender}
        ...
        \hfill
        {\ttfamily\small\bfseries\color{MoriPurple}CVE-2026-31431}
        \par
    }
    \vspace{2.25cm}
...
\appendix
% ------------------------------------------------------------
% Appendix A is maintained as a separate, versioned source file so that the
% evidence catalogue can be revised without rewriting the report preamble or
% analytical chapters.
